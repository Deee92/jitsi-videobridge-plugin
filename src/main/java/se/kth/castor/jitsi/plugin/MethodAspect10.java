...
public class MethodAspect10 {
    @Pointcut(className = "org.jitsi.videobridge.cc.BitrateController",
            methodName = "getAvailableBandwidth",
            methodParameterTypes = {"long"},
            timerName = "BitrateController - getAvailableBandwidth")
