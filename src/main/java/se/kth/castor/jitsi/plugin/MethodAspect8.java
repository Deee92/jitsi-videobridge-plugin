...
public class MethodAspect8 {
    @Pointcut(className = "org.jitsi.videobridge.cc.BitrateController$TrackBitrateAllocation",
            methodName = "getTargetBitrate",
            methodParameterTypes = {},
            timerName = "BitrateController$TrackBitrateAllocation - getTargetBitrate")
