...
public class MethodAspect9 {
    @Pointcut(className = "org.jitsi.videobridge.cc.BandwidthProbing",
            methodName = "getSenderSSRC",
            methodParameterTypes = {},
            timerName = "BandwidthProbing - getSenderSSRC")
