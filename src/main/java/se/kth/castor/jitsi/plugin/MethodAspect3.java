...
public class MethodAspect3 {
    @Pointcut(className = "org.jitsi.videobridge.cc.GenericAdaptiveTrackProjectionContext",
            methodName = "rewriteRtcp",
            methodParameterTypes = {"org.jitsi.rtp.rtcp.RtcpSrPacket"},
            timerName = "GenericAdaptiveTrackProjectionContext - rewriteRtcp")
