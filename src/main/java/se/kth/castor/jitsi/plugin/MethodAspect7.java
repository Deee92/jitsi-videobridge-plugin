...
public class MethodAspect7 {
    @Pointcut(className = "org.jitsi.videobridge.cc.vp8.VP8Frame",
            methodName = "matchesSSRC",
            methodParameterTypes = {"org.jitsi.videobridge.cc.vp8.VP8Frame"},
            timerName = "VP8Frame - matchesSSRC")
